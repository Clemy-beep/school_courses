...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Lesson::class, mappedBy: 'applicants')]
    private $lessons;

    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Grade::class, orphanRemoval: true)]
    private $grades;
